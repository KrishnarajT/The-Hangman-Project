...
string topic = "Colors", theme = "John Wick";
...
class General
{
	...
	sf::Texture Background_Texture, Video_Texture, Border_Texture, Mini_Border_Texture;;
	sf::Sprite Back_Image, Video_Image, Border, Soul_Stone_Video_Image, Loki_Video_Image;
	sf::Text Game_Name, Play_Game, How_To, About, Records, Quit, Store, ch1, ch2, ch3, ch4, ch5, ch6, Back_To_Menu, Present_Word, Time_Passed, Time_Val, Enter_Player_Name, Player_Name, Underline, Dialog, Topic_Select_Text;
...
class Dialog_Box : public General {
	...
	string one, two, Func;//Strings for the words to display in the dialog later to be converted into their correspondin char pointers.
	...
	void SetText()
	{
		...
		{
			ch1.setOrigin( -115, -150 );
			ch2.setOrigin( -650, -350 );
			one += " ";
			one += to_string( Player_Info_Obj.points );
		}
		else if (Func == "Settings")
		{
			ch1.setOrigin( -115, -150 );
...
Settings_Disp_Cant( "ITEM NOT BOUGHT", "OK", "Settings" ),
...
class Video_and_Image_Files : public General {
	...
	{
		filename = "Themes/Classic/Hangman-sad1.png";
		const char *cstr = filename.c_str();
		Video_Texture.loadFromFile( cstr );
		Video_Image.setTexture( Video_Texture );
		val++;
	...
	{
		filename = "Themes/Marvel/Test 2/test (" + to_string( val );
		filename += ").jpg";
		const char *cstr = filename.c_str();
		Video_Texture.loadFromFile( cstr );
		Video_Image.setTexture( Video_Texture );
	...
	{
		filename = "Themes/Marvel/Test 3/test (" + to_string( val );
		filename += ").jpg";
		const char *cstr = filename.c_str();
		Video_Texture.loadFromFile( cstr );
		Video_Image.setTexture( Video_Texture );
	...
	int  Main()
	{
		...
		while (window.isOpen())
		{
			...
			if (theme == "Classic")
			{
				switch (life)
				{
					case 0:Show_Image_Theme_2_Pic_6();
						break;
					case 1:Show_Image_Theme_2_Pic_5();
						break;
					case 2:Show_Image_Theme_2_Pic_4();
						break;
					case 3:Show_Image_Theme_2_Pic_3();
						break;
					case 4:Show_Image_Theme_2_Pic_2();
						break;
					case 5:Show_Image_Theme_2_Pic_1();
						break;
					case 6:Show_Image_Theme_2_Pic_Null();
						break;
					case 100:Show_Image_Theme_2_Pic_Win();
						break;
				}
			...
			else if (theme == "Marvel")
			{
				switch (life)
				{
					case 0:Play_Video_Theme_4_Scene_8();
						break;
					case 1:Play_Video_Theme_4_Scene_7();
						break;
					case 2:Play_Video_Theme_4_Scene_6();
						break;
					case 3:Play_Video_Theme_4_Scene_5();
						break;
					case 4:Play_Video_Theme_4_Scene_4();
						break;
					case 5:Play_Video_Theme_4_Scene_3();
						break;
					case 6:Play_Video_Theme_4_Scene_2();
						break;
					case 7:Play_Video_Theme_4_Scene_1();
						break;
					case 8:Show_Image_Theme_4_Pic_Null();
						break;
					case 100:Play_Video_Theme_4_Scene_Win();
						break;
				}
				if (life == 0 && val == 500)
				{
			...
			else if (theme == "Harry Potter")
			{
				switch (life)
				{
					case 0:Play_Video_Theme_3_Scene_7();
						break;
					case 1:Play_Video_Theme_3_Scene_6();
						break;
					case 2:Play_Video_Theme_3_Scene_5();
						break;
					case 3:Play_Video_Theme_3_Scene_4();
						break;
					case 4:Play_Video_Theme_3_Scene_3();
						break;
					case 5:Play_Video_Theme_3_Scene_2();
						break;
					case 6:Play_Video_Theme_3_Scene_1();
						break;
					case 7:Show_Image_Theme_3_Pic_Null();
						break;
					case 100:Play_Video_Theme_3_Scene_Win();
						break;
				}
				if (life == 0 && val == 500)
				{
			...
			else if (theme == "John Wick")
			{
				switch (life)
				{
					case 0:Play_Video_Theme_1_Scene_3();
						break;
					case 1:Play_Video_Theme_1_Scene_2();
						break;
					case 2:Play_Video_Theme_1_Scene_1();
						break;
					case 3:Play_Video_Theme_1_Scene_Null();
						break;
					case 100:Play_Video_Theme_1_Scene_Win();
						break;
				}
				if (life == 0 && val == 500)
				{
